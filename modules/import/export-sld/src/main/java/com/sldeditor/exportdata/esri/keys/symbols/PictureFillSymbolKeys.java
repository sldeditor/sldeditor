...
/**
 * The Class PictureFillSymbolKeys, contains all the keys used within
 * the intermediate json file to represent an Esri MXD picture fill symbols that the
 * SLD Editor can understand.
 *
 * @author Robert Ward (SCISYS)
 */
public class PictureFillSymbolKeys {

    public static final String PICTURE_FILL_SYMBOL = "PictureFillSymbol";
