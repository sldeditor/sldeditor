...
/**
 * The Class PercentageFormatKeys, contains all the keys used within
 * the intermediate json file to represent an Esri MXD percentage format that the
 * SLD Editor can understand.
 *
 * @author Robert Ward (SCISYS)
 */
public class PercentageFormatKeys {
