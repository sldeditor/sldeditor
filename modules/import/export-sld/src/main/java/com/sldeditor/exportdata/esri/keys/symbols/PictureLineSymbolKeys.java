...
/**
 * The Class PictureLineSymbolKeys, contains all the keys used within
 * the intermediate json file to represent an Esri MXD picture line symbols that the
 * SLD Editor can understand.
 *
 * @author Robert Ward (SCISYS)
 */
public class PictureLineSymbolKeys {

    public static final String PICTURE_LINE_SYMBOL = "PictureLineSymbol";
