...
/**
 * The Class NumericFormatKeys, contains all the keys used within
 * the intermediate json file to represent an Esri MXD numeric format that the
 * SLD Editor can understand.
 *
 * @author Robert Ward (SCISYS)
 */
public class NumericFormatKeys {
