...
/**
 * The Class SimpleRendererKeys, contains all the keys used within
 * the intermediate json file to represent an Esri MXD simple renderer that the
 * SLD Editor can understand.
 *
 * @author Robert Ward (SCISYS)
 */
public class SimpleRendererKeys {

    public static final String RENDERER_SIMPLE = "SimpleRenderer";
