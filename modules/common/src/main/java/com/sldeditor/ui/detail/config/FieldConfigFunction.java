...
/**
 * The Class FieldConfigFunction wraps a text field GUI component.
 * <p>
 ...
 */
public class FieldConfigFunction extends FieldConfigBase implements UndoActionInterface {
    ...
    public FieldConfigFunction(Class<?> panelId, FieldId id, String label, boolean valueOnly, String buttonText, boolean multipleFields, Class<?> fieldType) {
        ...
        this.setFunctionParameterType(fieldType);
    ...
    public void createUI(MultipleFieldInterface parentPanel, Box parentBox) {
        ...
        if(!isValueOnly())
        {
            setAttributeSelectionPanel(fieldPanel.internalCreateAttrButton(fieldType , this));
        }
    }
    ...
    protected FieldConfigBase createCopy(FieldConfigBase fieldConfigBase) {
        FieldConfigFunction copy = new FieldConfigFunction(fieldConfigBase.getPanelId(),
