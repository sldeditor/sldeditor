...
/**
 * The Class DummyExternalSLDFileError, the shape file feature source size field is not compatible
 * with the SLD.
 *
 * @author Robert Ward (SCISYS)
 */
public class DummyExternalSLDFileError implements SLDEditorFileInterface {
    ...
    public DummyExternalSLDFileError() {
        String sldContents =
        ...
        URL url =
                SLDEditorFile.class
                        .getClassLoader()
                        .getResource("point/sld/shp/sld_cookbook_point_error.shp");
    ...
    public String getTypeName() {
        return "sld_cookbook_point_error";
    }
}
