...
/**
 * The Class DummyInlineSLDFile2.
 *
 * @author Robert Ward (SCISYS)
 */
public class DummyInlineSLDFile2 implements SLDEditorFileInterface {
    ...
    /**
     * Instantiates a new dummy inline SLD file 2.
     */
    public DummyInlineSLDFile2() {
        String sldContents = "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>"
                ...
                + "<sld:Name>Inline2</sld:Name>" + "<sld:InlineFeature>" + "  <FeatureCollection>"
                + "    <featureMember>" + "      <gml:_Feature>" + "        <geometryProperty>"
                + "          <Polygon>" + "            <outerBoundaryIs>"
                + "              <LinearRing>"
                + "                <coordinates>-67,51 -50,51 -50,41 67,41 -67,51</coordinates>"
                + "              </LinearRing>" + "            </outerBoundaryIs>"
                + "          </Polygon>" + "        </geometryProperty>"
                + "        <title>Somewhere</title>" + "      </gml:_Feature>"
        ...
        URL url = SLDEditorFile.class.getClassLoader()
                .getResource("polygon/sld/shp/sld_cookbook_polygon.shp");
