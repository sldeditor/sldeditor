    ...
    public void testRuleRenderVisitor() {
        ...
        if (styledLayer instanceof NamedLayerImpl) {
            ...
            RuleRenderVisitor visitor =
                    new RuleRenderVisitor(ftsToRender, null, symbolIndex, new RuleRenderOptions());
            ...
            symbolIndex = 1;
            visitor =
                    new RuleRenderVisitor(
                            ftsToRender, ruleToRender, symbolIndex, new RuleRenderOptions());
            style.accept(visitor);
