...
public class InlineFeatureUtilsTest {
    ...
    private static String testInline1a =
            "<sld:StyledLayerDescriptor xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.opengis.net/sld StyledLayerDescriptor.xsd\" xmlns:gml=\"http://www.opengis.net/gml\" xmlns:sld=\"http://www.opengis.net/sld\" version=\"1.0.0\">"
                    + "<sld:UserLayer>"
    ...
    private static String testInline1b =
            "<sld:StyledLayerDescriptor xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.opengis.net/sld StyledLayerDescriptor.xsd\" xmlns:gml=\"http://www.opengis.net/gml\" xmlns:sld=\"http://www.opengis.net/sld\" version=\"1.0.0\">"
                    + "<sld:UserLayer>"
                    + "<sld:Name>Inline</sld:Name>"
                    + "<sld:InlineFeature>"
    ...
    private static String testInline2 =
            "   <FeatureCollection>"
                    + "      <gml:featureMember>"
                    + "        <feature>"
                    + "          <geometryProperty>"
    ...
    private static String testNoInline =
            "<sld:StyledLayerDescriptor xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.opengis.net/sld StyledLayerDescriptor.xsd\" xmlns:gml=\"http://www.opengis.net/gml\" xmlns:sld=\"http://www.opengis.net/sld\" version=\"1.0.0\">"
                    + "<sld:UserLayer>"
                    + "<sld:Name>Inline</sld:Name>"
                    + "</sld:UserLayer>"
    ...
    /**
     * Test method for {@link
     * com.sldeditor.ui.detail.config.inlinefeature.InlineFeatureUtils#extractUserLayers(org.geotools.styling.StyledLayerDescriptor)}.
     */
    @Test
    ...
    /**
     * Test method for. {@link
     * com.sldeditor.ui.detail.config.inlinefeature.InlineFeatureUtils#combineGeometryType()}.
     */
    @Test
    public void testCombineGeometryType() {
        ...
        assertEquals(
                GeometryTypeEnum.POINT, InlineFeatureUtils.combineGeometryType(geometryFeatures));

        geometryFeatures =
                Arrays.asList(
                        GeometryTypeEnum.LINE, GeometryTypeEnum.POINT, GeometryTypeEnum.POLYGON);
        assertEquals(
                GeometryTypeEnum.LINE, InlineFeatureUtils.combineGeometryType(geometryFeatures));
    }
}
