 ...
 */
public class VOChannelNameGreyNoExpression extends VOChannelNameNoExpression {
     ...
     */
    public VOChannelNameGreyNoExpression(Class<?> panelId, String panelConfig, FieldIdEnum fieldId) {
