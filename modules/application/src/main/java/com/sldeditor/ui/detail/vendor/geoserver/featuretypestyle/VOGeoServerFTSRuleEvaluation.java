...
public class VOGeoServerFTSRuleEvaluation extends StandardPanel
    ...
    /** The Constant DEFAULT_COMPOSITE_RULE_EVALUATION. */
    private static final String DEFAULT_COMPOSITE_RULE_EVALUATION = "all";

    /** The Constant PANEL_CONFIG. */
    private static final String PANEL_CONFIG = "featuretypestyle/PanelConfig_RuleEvaluation.xml";
     ...
     */
    public VOGeoServerFTSRuleEvaluation(Class<?> panelId) {
        super(panelId);
