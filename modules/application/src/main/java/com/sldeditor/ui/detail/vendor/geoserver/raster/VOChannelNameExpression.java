...
/**
 * Class to handle the getting and setting of raster channel names using expressions
 *
 * @author Robert Ward (SCISYS)
 */
public class VOChannelNameExpression extends StandardPanel
    ...
    public void populate(SelectedChannelType channelType) {
        if (channelType != null) {
            ...
            fieldConfigVisitor.populateField(this.fieldId, channelName);
        }
    }
    ...
    public void updateSymbol(SelectedChannelType channelType) {
        if (channelType != null) {
            Expression channelName = fieldConfigVisitor.getExpression(this.fieldId);
            ...
            vendorOptionInfo =
                    new VendorOptionInfo(
                            Localisation.getString(
                                    ChannelName.class, "channelname.expression.title"),
                            this.getVendorOption(),
                            Localisation.getString(
                                    ChannelName.class, "channelname.expression.description"));
        }
