...
public class XMLFieldLiteralBoolean extends XMLFieldLiteralBase {

    @XmlAttribute(name = "value")
    protected Boolean value;

    /**
     * Gets the value of the value property. This getter has been renamed from isValue() to
     * getValue() by cxf-xjc-boolean plugin.
     *
