...
public class XMLFieldConfigInteger extends XMLFieldConfigData {
    ...
    @XmlAttribute protected Integer defaultValue;
    @XmlAttribute protected Integer minValue;
    @XmlAttribute protected Integer maxValue;
    @XmlAttribute protected Integer stepSize;
