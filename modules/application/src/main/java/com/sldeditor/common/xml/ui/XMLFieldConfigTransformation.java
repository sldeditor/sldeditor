...
public class XMLFieldConfigTransformation extends XMLFieldConfigData {

    @XmlAttribute protected String editButtonText;
    @XmlAttribute protected String clearButtonText;
