...
/**
 * Unit test for SimpleRenderer class.
 * <p>{@link com.sldeditor.importdata.esri.renderer.SimpleRenderer}
 * 
...
public class SimpleRendererTest {
    ...
    /**
     * Test method for {@link com.sldeditor.importdata.esri.renderer.SimpleRenderer#convert(com.google.gson.JsonObject, java.lang.String, double, double, int)}.
     */
    @Test
    public void testConvert() {
        ...
        JsonElement json = ParserUtils.readTestData("/SimpleRenderer.json");
        ...
        assertEquals("Test Layer", rule.getName());
    }
