...
/**
 * The Class RateFormatKeys, contains all the keys used within
 * the intermediate json file to represent an Esri MXD rate format that the
 * SLD Editor can understand.
 *
 * @author Robert Ward (SCISYS)
 */
public class RateFormatKeys {

    public static final String RATE_FORMAT = "RateFormat";
    public static final String ALIGNMENT_OPTION = "alignmentOption";
    public static final String ALIGNMENT_WIDTH = "alignmentWidth";
    public static final String RATE_STRING = "rateString";
    public static final String RATE_FACTOR = "rateFactor";
