...
/**
 * The Class BalloonCalloutKeys, contains all the keys used within
 * the intermediate json file to represent an Esri MXD balloon callouts that the
 * SLD Editor can understand.
 *
 * @author Robert Ward (SCISYS)
 */
public class BalloonCalloutKeys {

    public static final String BALLOON_CALLOUT = "BalloonCallout";
